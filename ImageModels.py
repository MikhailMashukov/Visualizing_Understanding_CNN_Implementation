...
from ImageModels4 import ModelBlock4
...
# AlexNet implementation from https://engmrk.com/alexnet-implementation-using-keras/
# corrected by me
def AlexnetModel_Mrk(classCount=DeepOptions.classCount):
    import keras
